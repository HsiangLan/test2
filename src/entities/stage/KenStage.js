...
export class KenStage {
    ...
    flag = new BackgroundAnimation(
        ...
        [['flag-1', 133], ['flag-2', 133], ['flag-3', 133]]//順序, 延遲
    );
    ...
    brownSuitGuy = new BackgroundAnimation(
        ...
        [
            ['brown-suit-1', 133], ['brown-suit-2', 133],
            ['brown-suit-3', 133], ['brown-suit-2', 133],
        ],
    );
    ...
    drawLargeBollard(context, camera) {
    ...
    drawForeground(context, camera) {
        this.drawLargeBollard(context, camera);
    }
}
